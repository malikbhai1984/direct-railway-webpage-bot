...
res.write(data: ${JSON.stringify({          predictions,          matches,         timestamp: moment().tz("Asia/Karachi").format("DD MMM YYYY, hh:mm:ss A"),         count: { matches: matches.length, predictions: predictions.length }       })}\\n\\n);
} catch (error) {
...
// ===================== START SERVER =====================
app.listen(PORT, () => {
console.log(╔════════════════════════════════════════════╗ ║   ⚽ FOOTBALL PREDICTION SYSTEM LIVE ⚽    ║ ║                                            ║ ║   🚀 Server: <http://localhost>:${PORT}     ║ ║   🕐 Timezone: Pakistan (PKT)              ║ ║   📊 Matches: Last 100 (Left Side)         ║ ║   🎯 Predictions: Last 100 (Right Side)    ║ ║                                            ║ ║   ✅ 15-min match fetch (96/day)           ║ ║   ✅ 5-min predictions update              ║ ║   ✅ Auto-delete old predictions           ║ ║   ✅ MongoDB properly connected            ║ ╚════════════════════════════════════════════╝  );
});
